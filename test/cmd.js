...
describe("express(1)", function() {
    ...
    describe("(no args)", function() {
        ...
        it("should provide debug instructions", function() {
            assert.ok(
                /DEBUG=express-1-no-args:\* (?:& )?npm start/.test(ctx.stdout)
            );
        });
    ...
    describe("--css <engine>", function() {
        ...
        describe("less", function() {
            ...
            it("should have basic files", function() {
                assert.notEqual(
                    ctx.files.indexOf("bin/www"),
                    -1,
                    "should have bin/www file"
                );
                assert.notEqual(
                    ctx.files.indexOf("app.js"),
                    -1,
                    "should have app.js file"
                );
                assert.notEqual(
                    ctx.files.indexOf("package.json"),
                    -1,
